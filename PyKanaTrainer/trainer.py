...
class KanaTrainer():
    ...
    def get_random_hiragana_list(self) -> list:
        kana_list = list(self._romaji_to_hiragana.values())
        random.shuffle(kana_list)
        return kana_list

    def check_romaji_to_hiragana(self, romaji: str, hiragana: str) -> bool:
        if self._romaji_to_hiragana[romaji] == hiragana:
            return True
        else:
            return False

    def check_hiragana_to_romaji(self, hiragana: str, romaji: str) -> bool:
        if self._hiragana_to_romaji[hiragana] == romaji:
            return True
        else:
            return False
#----------------------------------------------- KANA DATA ------------------------------------------
